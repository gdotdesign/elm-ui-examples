module VideoLibrary.VideoModal where
...
import VideoLibrary.VideoForm as Form
...
openWithVideo : Video -> Model -> Model
openWithVideo video model =
  { model | modal = Ui.Modal.open model.modal
          , form = Form.fromVideo video
  }
